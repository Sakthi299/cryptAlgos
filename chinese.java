...
public class chinese {
	...
	public static void main(String[] args) 
		...
		System.out.println("Enter the size of the equations: ");
		size = input.nextInt();
...
*/
		print("The smallest number that gets divided by the given numbers leaves the corresponding remainders is "+computeMinX(rem,num));
		// print("sum = "+sum+"\n");
	}
